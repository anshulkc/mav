// Import Zod components directly
import * as zod from "zod";
// Create z object manually with the methods we need
const z = {
  object: zod.object || ((schema: any) => zod.ZodObject.create(schema)),
  string: zod.string || (() => zod.ZodString.create()),
  array: zod.array || ((schema: any) => zod.ZodArray.create(schema)),
};
